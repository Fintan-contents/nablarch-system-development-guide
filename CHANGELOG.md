...
- スタイルガイドの修正
  - [スタイルガイド 3.2版から5.0版までの修正](https://github.com/Fintan-contents/coding-standards/blob/main/CHANGELOG.md)を元に、以下の変更を実施しました。
    - 使用不許可APIチェックツール
    ...
    - 使用不許可APIチェックツール
      ...
      - 設定ファイルのサンプルを配置しました。
    - Nablarchに依存しない内容については、Nablarchの表記を取り除いた記載に修正しました。
