            ...
            <div class="ui grid">
                ...
                <div class="ui form">
                    <div class="ui two column grid">
                        ...
                        <div class="row">
                            <div class="column">
                                <h5 class="ui header">Division/department</h5>
                        ...
                        <div class="row">
                            <div class="sixteen wide column">
                                <h5 class="ui header">Project name</h5>
                                <n:write name="project.projectName"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="column">
                                <h5 class="ui header">Project type</h5>
                                <n:code codeId="C0300001" name="project.projectType"/>
                            </div>
                            <div class="column">
                                <h5 class="ui header">Project classification</h5>
                        ...
                        <div class="row">
                            <div class="column">
                                ...
                                <n:write value="${n:format('number', project.salesAmount, '###,###,###')}"/>
                            </div>
                            <div class="column">
