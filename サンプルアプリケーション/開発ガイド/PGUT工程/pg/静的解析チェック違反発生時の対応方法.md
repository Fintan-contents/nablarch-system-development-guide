...
- https://collaborage-ci.keel-dev.net/gitbucket/shaft/proman-style-guide/blob/master/java/staticanalysis/checkstyle/docs/Ops-Rule.md
- https://collaborage-ci.keel-dev.net/gitbucket/shaft/proman-style-guide/blob/master/java/staticanalysis/spotbugs/docs/Ops-Rule.md
...
これにより、除外設定した理由や経緯をRedmineチケットで追跡できるようにする。
...
ホワイトリストリストに追加すると、どのクラスからも使用可能となってしまうためです。
