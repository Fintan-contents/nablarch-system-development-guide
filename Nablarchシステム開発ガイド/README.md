...
本ガイドは、Nablarchを使ってシステムを開発するエンジニアに対して、開発開始前・開発中になにをすべきか、なにを参照すれば良いかを示すものです。Nablarchを使ったシステム開発に必要と考えているアクティビティについて、多くのプロジェクトで最適と思われる進め方を記載しています。

多くのNablarch利用プロジェクトの特性を踏まえて、開発プロセスはウォーターフォール開発を想定しています。


プロジェクト本格開始前に本ガイドを一通り確認して、開発をどのように進めるか検討してください。

### 本ガイドのねらい

本ガイドは以下の項目を達成することをねらいとしています。
...
本ガイドの「全体像」から「結合テスト工程」までのセクションでは、システム開発全体の進め方について記載しています。
システム開発全体の進め方の記載には、多くのリンクが存在します。
リンク先のドキュメントも多く、最初に読み進める段階でリンクを追っていくと全体像をつかみにくくなります。
最初はあまりリンク先に飛ばず「こんなリンクがあるんだな」くらいの認識で、システム開発全体の進め方を最後まで読むようにしてください。
...
- [Nablarchを使用した開発の流れ](../Sample_Project/設計書/Nablarchを使用した開発の流れ.xlsx?raw=true)
...
- [Nablarch機能のセキュリティ対応表](../Sample_Project/設計書/Nablarch機能のセキュリティ対応表.xlsx?raw=true)
...
[サンプルプロジェクト](../Sample_Project)では、品質を極力犠牲にせずに  
...
- [軽量型のテスト標準](../Sample_Project/設計書/A1_プロジェクト管理システム/020_方式設計/020_開発標準/020_テスト標準/単体テスト標準.xlsx?raw=true)  
- [軽量型を採用した単体テストの考え方（Web)](../Sample_Project/サンプルプロジェクト開発ガイド/PGUT工程/ut/単体テストの考え方（Web）.md)
...
- [サンプルプロジェクト開発ガイド](../Sample_Project/サンプルプロジェクト開発ガイド)
...
- [設計標準](../Sample_Project/設計書/A1_プロジェクト管理システム/020_方式設計/020_開発標準/010_設計標準)
- [テスト標準](../Sample_Project/設計書/A1_プロジェクト管理システム/020_方式設計/020_開発標準/020_テスト標準)
